...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <div>
            <h5 class="align-items-center"><spring:message code="view.pages.user.table-title" /></h5>
        </div>
        <div>
            <a href="<c:url value="/admin/user/create" />" class="btn btn-success"><spring:message code="view.pages.user.button-create" /></a>
        </div>
    </div>
